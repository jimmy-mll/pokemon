...
/// <summary>Describes a way to parse a network messages.</summary>
public interface IMessageParser
{
	/// <summary>Decodes a message from the given <paramref name="sequence" />.</summary>
	...
	/// <summary>Encodes a network message into a <see cref="ReadOnlyMemory{T}" />.</summary>
