...
public static class RandomExtensions
{
	...
	public static Vector2 NextVector2(this Random random, in Rectangle rectangle) =>
		new(random.Next(rectangle.X, rectangle.X + rectangle.Width),
			random.Next(rectangle.Y, rectangle.Y + rectangle.Height));
	...
	///     When the <paramref name="src" /> is empty or <paramref name="length" /> is
	///     negative.
	/// </exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
